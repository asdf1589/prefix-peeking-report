...
workloads = [
    ('Gemma-3-4B\narXiv QA\n(90k ctx)',  {'LRU': 0.1203, 'PPE': 0.2253, 'PPS': 0.1747, 'Both': 0.2692}),
    ('Ministral-8B\narXiv QA\n(32k ctx)', {'LRU': 0.1725, 'PPE': 0.1766, 'PPS': 0.2044, 'Both': 0.2193}),
    ('Llama-3.1-8B\narXiv QA\n(50k ctx)', {'LRU': 0.0574, 'PPE': 0.0542, 'PPS': 0.0607, 'Both': 0.0613}),
